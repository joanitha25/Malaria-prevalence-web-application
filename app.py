...
# ==========================================
with about_tab:
    # Use an explicit container to sandbox the About text entirely inside Tab 1
...
# ==========================================
with prediction_tab:
    # Use a separate explicit container to sandbox the Prediction Workspace inside Tab 2
    ...
    with prediction_container:
        ...
        # Map display system strictly retained inside the prediction tab container
